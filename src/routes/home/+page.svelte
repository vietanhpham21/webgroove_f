...
// @ts-nocheck
    ...
    import { bpmStore, loggedIn, resetProject, showOpenProjectDialog, fetchUrl, projectOwner, isNewProject, projectOwnerId, projectNameStore, readOnlyMode } from "$lib/stores";
